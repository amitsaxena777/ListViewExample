...
public class ListViewWithSimpleAdapter extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] codeLearnChapters = new String[] { "Android Introduction","Android Setup/Installation","Android Hello World",
        		"Android Layouts/Viewgroups","Android Activity & Lifecycle","Intents in Android","Android Activity & Lifecycle","Intents in Android"
                ,"Android Activity & Lifecycle","Intents in Android","Android Activity & Lifecycle","Intents in Android","Android Activity & Lifecycle","Intents in Android"};
